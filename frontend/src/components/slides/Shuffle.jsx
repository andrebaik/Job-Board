...
const Shuffle = ({
  ...
  useEffect(() => {
    const ready = "fonts" in document
      ...
      : Promise.resolve();
    ready.then(() => setFontsLoaded(true));
  }, []);
  ...
  useGSAP(() => {
    ...
    dependencies: [
      text, duration, maxDelay, ease, fontsLoaded,
      shuffleDirection, shuffleTimes, animationMode,
      loop, loopDelay, stagger, scrambleCharset,
      colorFrom, colorTo, respectReducedMotion,
      triggerOnHover, onShuffleComplete, userHasFont
    ],
    scope: ref
  });
  ...
  return React.createElement(Tag, { ref, className: classes, style: { textAlign, ...style } }, text);
};
