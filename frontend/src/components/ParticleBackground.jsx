...
function ParticleBackground({ className = "fixed inset-0 z-0", opacity = 0.5 }) {
  ...
  return (
    <canvas
      ref={canvasRef}
      className={`${className} w-full h-full mix-blend-screen pointer-events-none`}
      style={{ opacity }}
    />
  );
}
...
export { ParticleBackground, AccentLines, PageBackground };
